#:if ([:len [/file find name=list-game.rsc]] > 0) do={/file remove list-game.rsc }; /tool fetch url="https://raw.githubusercontent.com/shfylqlby/mikrotik/master/address-list/list-game.rsc";/import list-game.rsc;
